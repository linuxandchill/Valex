defmodule Ratios do 
  ...
  def eps() do 
    %HTTPoison.Response{body: net_income} = 
      HTTPoison.get! "https://api.intrinio.com/" <> "data_point?identifier=AAPL&item=netincome", @headers
    net_income = net_income |> Poison.decode! |> Map.get("value") |> round

    %HTTPoison.Response{body: shares_os} = 
      HTTPoison.get! "https://api.intrinio.com/" <> "data_point?identifier=AAPL&item=weightedavedilutedsharesos", @headers
